...
class PelaporLaporan extends CI_Controller 
{
	...
	public function index()
	{
		...
		{
			$data['pengaduan']	= $this->pepemo->getPengaduanFilterByIdMasyarakat($_POST['dari_tgl'], $_POST['sampai_tgl'], $_POST['status_pengaduan'], $data['dataUser']['id']);
		}
		else
		{
			$data['pengaduan']	= $this->pepemo->getPengaduanByIdMasyarakat($data['dataUser']['id']);
		}
